...
function Productdetails() {
    ...
    const photo = products.find(products => products._id === photoId);
        ...
        <div className='container p-5'>
            ...
            <div className='row my-auto align-items-center justify-content-center'>
                <div className='col-md-5'>
                    <img className='mt-3 photo-max-size img-fluid' src={photo.imageUrl} alt={photo.itemName} />
                </div>
                <div className='col-md-5'>
                    <h2>{photo.itemName}</h2>
                    <p className='product-info' style={{ color: '#d90700' }}>{photo.desc}</p>
                    ...
                    <div className="contact-buttons mt-3 d-flex">
                        <button className='btn btn-primary me-2' onClick={() => { formshow(photo.itemName) }}>Inquiry now</button>
